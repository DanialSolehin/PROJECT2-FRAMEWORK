        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (_image != null) SizedBox(height: 20.0),
              ElevatedButton(
                onPressed: () {
  ...
  Future<void> _updatePlace() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Handle error if the update request was not successful
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                ...
                // Place editedPlace = Place(
                //   placeId:
                //     'something', //TODO: MODIFY IT WHEN YOU MAKE THE UPDATE FUNCTIONALITY
                // placeName: _placeNameController.text,
                // description: _descriptionController.text,
                // imagePath: _imagePathController.text,
                // special: _specialController.text,
